...
async function generatePDF({ courseName, dateStr, sessionType, recallText, concepts, main, summary }) {
  ...
  doc.setFont('helvetica', 'bold')
  doc.text('StudyMap Session Notes', margin, 9)
  doc.setFontSize(9)
  doc.setFont('helvetica', 'normal')
  ...
  doc.setFont('helvetica', 'normal')
  doc.text('Generated by StudyMap • studymap.app', pageW / 2, pageH - 8, { align: 'center' })

  const filename = `StudyMap_${courseName.replace(/\s+/g, '_')}_${dateStr}.pdf`
  doc.save(filename)
}
