...
export default function PracticeExamModal({ course, onStart, onClose, onShowPaywall }) {
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label="Practice exam" style={{ position: 'fixed', inset: 0, zIndex: 200, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16, background: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(6px)' }}>
