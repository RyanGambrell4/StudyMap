        ...
        <div className="max-w-xl mx-auto px-5 py-4 pb-10">
          ...
          {!blueprint && (
            <div className="mb-6">
              ...
              <p className="text-slate-500 text-sm mb-6">Your session, mapped out before you start. Tell us what you're working with — we'll build the plan.</p>
              ...
              <input
                ...
                placeholder="e.g. 'WACC formula and capital structure' or leave blank to let StudyMap decide"
