        ...
        {view === 'gift' && (
          <>
            ...
            <p style={{ margin: '0 0 18px', fontSize: 13, color: MUTED, lineHeight: 1.55, background: '#FFF6F0', border: `1px solid ${ACCENT}25`, borderRadius: 10, padding: '10px 14px' }}>
              Or skip the gift and start a <strong style={{ color: ACCENT }}>7-day free trial</strong>. Card required · $4.99/wk after 7 days. Unlimited sessions, 5 courses, 100 AI actions/month. Cancel anytime.
            </p>
            {claimError && (
