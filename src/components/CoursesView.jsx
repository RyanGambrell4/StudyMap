  ...
  return (
    <>
      ...
      <div className="cv-header-pad" style={{ padding: '28px 32px 20px', borderBottom: `1px solid ${D.border}`, display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 20, flexWrap: 'wrap' }}>
        ...
        >
          <Icon name="plus" size={14} /> {atLimit ? (isExamMode ? 'Add section' : 'Add course') : isExamMode ? 'Add Section' : 'Add Course'}
        </button>
      </div>
      ...
      <div className="cv-page-pad" style={{ padding: '24px 32px 48px' }}>
        {courses.length === 0 && !isExamMode && (() => {
          const TEMPLATES = [
            ...
            { name: 'Psychology', difficulty: 'Medium', targetGrade: 'A', dot: '#9333EA' },
            ...
            { name: 'Physics', difficulty: 'Hard', targetGrade: 'B', dot: '#0284C7' },
          ]
          return (
