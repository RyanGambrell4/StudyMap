export default function TodayFocus({ nextSession, onStartFocus }) {
  ...
  return (
    <div
      className="no-print relative overflow-hidden bg-white rounded-2xl mb-6"
      ...
      <div className="relative px-5 py-4 flex items-center gap-4 flex-wrap">
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-slate-900 font-bold text-lg leading-tight">{nextSession.courseName}</span>
          </div>
