              ...
              <div style={{ position: 'absolute', top: '100%', left: 0, width: 256, background: '#FFFFFF', border: `1px solid ${BORDER}`, borderRadius: 12, boxShadow: '0 8px 32px rgba(0,0,0,0.12)', padding: 12, zIndex: 200 }}>
                ...
                >
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: 11.5, color: MUTED, lineHeight: 1.4 }}>Build your weekly study plan</div>
                  </div>
                </button>
                ...
                <button
                  ...
                  onMouseLeave={e => e.currentTarget.style.background = 'none'}
                >
                  <div style={{ width: 32, height: 32, borderRadius: 8, background: 'rgba(139,92,246,0.10)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <svg width="15" height="15" fill="none" stroke="#7C3AED" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                  ...
                  <div>
                    <div style={{ fontSize: 13, fontWeight: 600, color: TEXT, marginBottom: 2 }}>Knowledge Map</div>
                    <div style={{ fontSize: 11.5, color: MUTED, lineHeight: 1.4 }}>See what you know, topic by topic</div>
                  </div>
                </button>
                ...
                >
                  <div style={{ width: 32, height: 32, borderRadius: 8, background: 'rgba(220,38,38,0.08)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
                    <svg width="15" height="15" fill="none" stroke="#DC2626" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
          ...
          <div style={{ borderTop: `1px solid ${BORDER}`, background: '#FFFFFF', padding: 16, animation: 'mob-hub-slide 0.2s cubic-bezier(0.16,1,0.3,1)' }}>
            ...
            {mobileHub === 'strategy' ? (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
                ...
                {[
                  { label: 'Study Coach',                        sub: 'Build your weekly study plan',   color: ACCENT,    section: 'coach',  iconPath: 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z' },
                  ...
                  { label: 'Knowledge Map',                      sub: 'See what you know, topic by topic', color: '#7C3AED', section: 'mastery', iconPath: 'M9 3a3 3 0 00-3 3 3 3 0 00-3 3v3a3 3 0 003 3v2a3 3 0 003 3 3 3 0 003-3V3z M15 3a3 3 0 013 3 3 3 0 013 3v3a3 3 0 01-3 3v2a3 3 0 01-3 3 3 3 0 01-3-3V3z' },
