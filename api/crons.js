...
// ─── Weekly Digest ───────────────────────────────────────────────────────────
// POST /api/crons?job=weekly-digest
// Sends a personalized Sunday digest to opted-in users: stats, grades, week ahead.
  ...
  <tr><td align="center">
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;">
      ...
      <tr><td style="padding:20px 0 0;text-align:center;">
        <a href="https://studyedgeai.com" style="display:inline-block;padding:13px 28px;background:#3B61C4;color:#FFFFFF;font-size:14px;font-weight:600;text-decoration:none;border-radius:10px;">Open StudyEdge</a>
      </td></tr>
