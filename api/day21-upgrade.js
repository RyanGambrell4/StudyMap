...
export default async function handler(req, res) {
  ...
  for (const user of eligible) {
    ...
    const upgradeUrl = trialUsed
      ...
      : `https://getstudyedge.com/app?signup=1&plan=pro&billing=monthly&trial=1&utm_source=email&utm_medium=lifecycle&utm_campaign=day21_upgrade`
    ...
    const bodyHtml = trialUsed ? `
        ...
        <p style="margin:0 0 16px;font-size:15px;color:#6B6B6B;line-height:1.65;">
          At $9.99/month, less than a coffee, the question isn't whether it's worth it. It's whether passing your next exam is worth $9.99 to you.
        </p>
        <table cellpadding="0" cellspacing="0" style="width:100%;margin-bottom:24px;background:#F7F6F3;border-radius:12px;overflow:hidden;">
          <tr><td style="padding:16px 20px;">
            ...
            ${[
              ...
              '100 AI actions/month → back to 5 total',
              '5 courses → back to 1',
        ...
        <table cellpadding="0" cellspacing="0" style="width:100%;">
          <tr><td align="center" style="padding-bottom:6px;">
            <a href="${upgradeUrl}" style="display:inline-block;background:#3B61C4;color:#FFFFFF;font-size:14px;font-weight:600;text-decoration:none;border-radius:10px;padding:13px 30px;">Get Pro back · $9.99/mo</a>
          </td></tr>
          <tr><td align="center">
        ...
        <p style="margin:0 0 16px;font-size:15px;color:#6B6B6B;line-height:1.65;">
          Pro is $9.99/month. For a full 13-week semester, that's $38.87. Split across every session, every AI boost, and every exam, it's less than $3 per week of actually being prepared.
        </p>
        <table cellpadding="0" cellspacing="0" style="width:100%;margin-bottom:24px;">
          ${[
            ['7-day free trial', 'Card required. Cancel before day 8 and pay nothing.'],
