    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;">
      ...
      <tr><td style="background:#FFFFFF;border-radius:16px;border:1px solid rgba(0,0,0,0.07);padding:32px 32px 28px;">
        ...
        <div style="margin:24px 0 0;background:#F4F7FF;border-radius:12px;border:1px solid rgba(59,97,196,0.18);padding:18px 20px;text-align:center;">
          ...
          <p style="margin:0 0 12px;font-size:12px;color:#9B9B9B;">Card required · Cancel before day 8 and pay nothing</p>
          <a href="https://getstudyedge.com/app?signup=1&plan=pro&billing=monthly&trial=1&utm_source=email&utm_medium=lifecycle&utm_campaign=early_activation_trial" style="display:inline-block;background:#E8531A;color:#FFFFFF;font-size:13px;font-weight:700;text-decoration:none;border-radius:8px;padding:11px 24px;">Start free 7-day trial →</a>
        </div>
        <p style="margin:22px 0 0;font-size:14px;color:#6B6B6B;line-height:1.65;">
          Reply if you have questions. We read them.<br>The StudyEdge AI Team
        </p>
      </td></tr>
