...
export default async function handler(req, res) {
  ...
  console.log(`[re-engage] Found ${dormant.length} dormant users`)
  let sent = 0
...
<body style="margin:0;padding:0;background:#080D1A;font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;">
    ...
    <tr><td align="center">
      <table width="560" cellpadding="0" cellspacing="0" style="background:#0D1425;border-radius:16px;border:1px solid rgba(255,255,255,0.07);padding:40px 48px;max-width:560px;">
        ...
        <tr><td style="padding-bottom:16px;">
          <h1 style="margin:0;font-size:24px;font-weight:800;color:#F1F5F9;letter-spacing:-0.8px;line-height:1.3;">Your study plan is waiting.</h1>
        </td></tr>
  ...
  console.log(`[re-engage] Sent ${sent}/${dormant.length}`)
