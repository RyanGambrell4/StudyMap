        ...
        <table cellpadding="0" cellspacing="0" style="width:100%;margin-top:20px;">
          <tr><td style="background:#F4F7FF;border-radius:12px;border:1px solid rgba(59,97,196,0.15);padding:16px 20px;text-align:center;">
            ...
            <p style="margin:0 0 12px;font-size:13px;color:#6B6B6B;line-height:1.55;">
              ${trialUsed
                ? 'Everything you had during your trial: unlimited AI tutoring, 5 courses, Blueprints every session, back permanently for $9.99/mo.'
            ...
            <a href="https://getstudyedge.com/app?${trialUsed ? 'upgrade=1' : 'signup=1&plan=pro&billing=monthly&trial=1'}&utm_source=email&utm_medium=lifecycle&utm_campaign=re_engage_${tier}_upsell" style="display:inline-block;background:#E8531A;color:#FFFFFF;font-size:13px;font-weight:600;text-decoration:none;border-radius:8px;padding:10px 22px;">
