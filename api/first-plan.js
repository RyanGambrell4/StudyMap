      ...
      <tr><td style="background:#FFFFFF;border-radius:16px;border:1px solid rgba(0,0,0,0.07);padding:32px 32px 28px;">
        ...
        <table cellpadding="0" cellspacing="0" style="width:100%;margin-top:20px;">
          <tr><td style="background:#F4F7FF;border-radius:12px;border:1px solid rgba(59,97,196,0.15);padding:14px 18px;text-align:center;">
            <p style="margin:0 0 5px;font-size:13px;font-weight:600;color:#3B61C4;">${trialUsed ? 'Unlock your full semester plan with Pro' : 'Your 7-day free trial is waiting'}</p>
            <p style="margin:0 0 10px;font-size:13px;color:#6B6B6B;line-height:1.55;">${trialUsed ? 'Unlimited AI tutoring, brain dumps, cheat sheets, and practice exams. Make the most of every session.' : 'Unlimited study tools, AI tutoring, and more. Card required · Cancel anytime before day 8 and pay nothing.'}</p>
