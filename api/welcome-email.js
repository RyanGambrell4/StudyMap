...
${preheader("You have 7 days of Pro free. Here's what to do first.")}
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="max-width:580px;">
      ...
      <tr><td style="background:#FFFFFF;border-radius:18px;border:1px solid rgba(0,0,0,0.06);padding:36px 36px 30px;box-shadow:0 1px 2px rgba(0,0,0,0.03);">
        ...
        <table cellpadding="0" cellspacing="0" style="width:100%;">
          ...
          <tr><td align="center">
            <span style="font-size:12.5px;color:#9B9B9B;">Card required · Cancel before day 8 and pay nothing</span>
          </td></tr>
        </table>
      </td></tr>
