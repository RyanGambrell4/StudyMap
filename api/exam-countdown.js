      ...
      <tr><td style="background:#FFFFFF;border-radius:16px;border:1px solid rgba(0,0,0,0.07);padding:32px 32px 28px;">
        ...
        <table cellpadding="0" cellspacing="0" style="width:100%;background:rgba(59,97,196,0.06);border:1px solid rgba(59,97,196,0.18);border-radius:12px;margin-top:22px;">
          <tr><td style="padding:16px 18px;">
            ...
            <div style="font-size:13px;color:#6B6B6B;line-height:1.55;margin-bottom:10px;">${trialUsed ? 'Unlimited AI blueprints, Study Coach, and Exam Rescue. Make the most of the time you have left.' : 'Pro gives you AI-built session plans, Study Coach, and 100 AI boosts/month for $2.99/wk. Try free for 7 days.'}</div>
            <a href="https://getstudyedge.com/app?upgrade=1&utm_source=email&utm_medium=lifecycle&utm_campaign=exam_countdown" style="font-size:13px;font-weight:600;color:#3B61C4;text-decoration:none;">${trialUsed ? 'Upgrade to Pro →' : 'Start 7-day free trial →'}</a>
          </td></tr>
        </table>` : ''}
      </td></tr>
