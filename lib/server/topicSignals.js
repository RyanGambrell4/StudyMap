...
//
// brain_dump_score is the dump's own graded result for the topic the
// student actually wrote about, so it carries full weight. It is the
// counterpart to brain_dump_gap: the gap rows say what was missed, this
// row says how the attempt scored. The Knowledge Map treats it as a
// scored event and brain_dump_gap as unscored evidence of activity.
export const SIGNAL_TYPE_SCORE_RULES = {
  brain_dump_gap:       { score: 0.0, weight: 0.5, source: 'server_graded' },
  brain_dump_score:     { score: null, weight: 1.0, source: 'server_graded' },
