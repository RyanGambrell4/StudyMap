...
describe('suppression list is missing (production today)', () => {
  ...
  it('says loudly that the table does not exist', async () => {
    ...
    // Must name the migration that is actually safe to run. 20260727 creates
    // all three tables without RLS; see migrations/20260821_..._v2.sql.
    expect(said).toMatch(/20260821_email_suppression_and_queue_v2/)
  })
